...
../MCAL/Stm32_F103C6_SPI_drivers.c \
...
./MCAL/Stm32_F103C6_SPI_drivers.o \
...
./MCAL/Stm32_F103C6_SPI_drivers.d \
...
MCAL/Stm32_F103C6_SPI_drivers.o: ../MCAL/Stm32_F103C6_SPI_drivers.c
	arm-none-eabi-gcc  -gdwarf-2 "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -DDEBUG -c -I../Inc -I"D:/Master Embeded system course/Workspace/STM32_Drivers/HAL/inc" -I"D:/Master Embeded system course/Workspace/STM32_Drivers/MCAL/inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"MCAL/Stm32_F103C6_SPI_drivers.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
